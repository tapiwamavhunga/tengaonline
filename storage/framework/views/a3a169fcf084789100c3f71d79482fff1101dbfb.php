<?php $__env->startSection('product-colors-list-content'); ?>
        ...
        <table class="table table-bordered table-striped admin-data-table">
          ...
          <tbody>
            <?php if(count($colors_list_data)>0): ?>
              <?php $__currentLoopData = $colors_list_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
              <tr>
